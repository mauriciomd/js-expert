...
describe('#HTTP Interceptor Agent', () => {
  ...
  test('should not change the header', () => {
    const response = {
  ...
  test('should activate the interceptor header', () => {
    ...
    expect(response.setHeader).toHaveBeenCalledWith('X-Instrumented-By', 'Decorator')
  })
})