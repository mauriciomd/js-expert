...
export default class RickAndMortyXML {
  static async getCharactersFromXML() {
    ...
    const { results: { element = []}} = await parseStringPromise(data, options)
    const defaultFormat = Array.isArray(element) ? element : [element]
